...
<head>
    <meta charset="utf-8">
    <title>Goshen Lab - Especialista em Análises</title>
        ...
        <div class="collapse text-center navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="#about" class="nav-item nav-link <?php if (url_is('about')) {
                                                                echo "active";
                                                            } ?> "><i class="fa-solid fa-users me-1"></i>Quem somos</a>
                <a href="#kit" class="nav-item nav-link <?php if (url_is('kit')) {
                                                            echo "active";
                                                        } ?>"><i class="fa-solid fa-bowl-food me-1"></i></i>Kit Desjejum</a>
                <!-- <a href="#blog" class="nav-item nav-link <?php if (url_is('blog')) {
                                                                    echo "active";
                                                                } ?>"><i class="fa-solid fa-notes-medical me-1"></i>Exames</a> -->
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa-solid fa-notes-medical me-1"></i>Exames</a>
                ...
                <a href="#kids" class="nav-item nav-link <?php if (url_is('treatments')) {
                                                                echo "active";
                                                            } ?>"><span><i class="fa-solid fa-children me-1"></i>Kids</span> </a>
                <!-- <div class="nav-item dropdown">
